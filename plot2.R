...
# Plot #2
#
# Assumes data set is in the folder specified in the argument to doPlot2(),
# the argument being the working directory for the program run. The output
# file, plot2.png, will be found in that directory when the run is complete.
...
doPlot2 <- function (workingDirectory = "~/Box Sync/Coursera-data-science/datasciencecoursera/Exploratory_Data_Analysis/Project1") {
